		...
		if (isset($data['product_discount'])) {
			...
			if (isset($data['product_special'])) {
				foreach ($data['product_special'] as $value) {
					...
					$this->db->query("INSERT INTO " . DB_PREFIX . "product_special SET product_id = '" . (int)$product_id . "', customer_group_id = '" . (int)$value['customer_group_id'] . "', priority = '" . (int)$value['priority'] . "', price = '" . (float)$value['price'] . "', date_start = '" . $this->db->escape($value['date_start']) . "', date_end = '" . $this->db->escape($value['date_end']) . "',promotion = '" .(int)$value['promotion']. "', time_start = '" . $this->db->escape($value['time_start']) . "',time_end = '" . $this->db->escape($value['time_end']) . "'");
				}
			}
