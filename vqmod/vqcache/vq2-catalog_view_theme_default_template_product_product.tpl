    ...
    <div class="right">
      <div class="description">
        ...
        <span><?php echo $text_stock; ?></span> <?php echo $stock; ?></div>
			...
			<div id="product_timer" class="timer" style="font-size:28px;color:#ff0000;"></div>
...
#group img{ width:100px; height:100px; }

.recommend .mt{padding-bottom:0;}
.recommend .tab{margin-bottom:0;}
.recommend .tab-sub{padding:8px 0 3px;}
.recommend .master{float:left;position:relative;width:125px;height:166px;background:#fff;border:solid #D8D7D3;border-width:1px 0 1px 1px;padding:0 35px 0 5px;text-align:center;}
.recommend .master .icon-add{position:absolute;top:45px;right:0;width:30px;height:30px;background-position:-181px 0; 
background-repeat: no-repeat;}
.recommend .suits{float:left;position:relative;width:420px;height:166px;background:#fff;border:solid #D8D7D3;border-width:1px 1px 1px 0;overflow-y:hidden;overflow-x:hidden;}
.recommend .suits ul{float:left;height:166px; margin:0; padding:0; }
.recommend .suits li{float:left;width:126px;padding:0 7px;text-align:center; list-style-type:none; }
.recommend .suits li .p-name{ height:36px; }
...
.recommend .btn-buy{float:left;width:70px;height:21px;text-align:center;line-height:21px;color:#fff;background-position:-141px -121px;}
...
<div class="p-img"><a href="<?php echo $self; ?>" title="<?php echo $heading_title; ?>" target="_blank"> <img
	src="<?php echo $thumb; ?>" width="100" height="100" alt="" /></a></div>
...
<?php foreach($groups as $result) {?>
	...
	<div class="choose"><input type="checkbox" price="<?php echo $result['price_amount']; ?>" value="<?php echo $result['product_id']; ?>"
		checked="true" onclick="buyGCombineBuy(this)"><span class="p-price"><strong><?php echo $result['price']; ?></strong></span></div>
	</li>
	<?php } ?>
</ul>
</div>
...
<?php foreach($groups as $result) {?>
<input type="hidden" value="<?php echo $result['product_id']; ?>" id="product_<?php echo $result['product_id']; ?>" name="product_ids[]" />
<?php } ?>
<div class="infos">
<div class="p-name">
...
//--></script> 
			...
			<?php if (isset($promotion_status)) { ?>
			<script type="text/javascript" src="catalog/view/javascript/jquery/jquery.countdown.1.0.js"></script>
			<script type="text/javascript">
			$(function(){
				$('#product_timer').countdown({
						 Sdate:'<?php echo $promotion_start;?>',
				         Edate:'<?php echo $promotion_end;?>'
				 });
			})
			</script>
			<?php } ?>
