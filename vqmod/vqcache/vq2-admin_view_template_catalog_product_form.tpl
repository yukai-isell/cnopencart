    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-links">
          <table class="form">
			...
			<tr>
              ...
              <td><input type="text" name="combine" value="" style="width:400px;" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div class="scrollbox" id="product-combine">
                  <?php $class = 'odd'; ?>
        ...
        <div id="tab-special">
			...
			<thead>
              <tr>
              	<td class="left"><?php echo $entry_promotion; ?></td>
                <td class="left"><?php echo $entry_customer_group; ?></td>
                <td class="right"><?php echo $entry_priority; ?></td>
                <td class="right"><?php echo $entry_price; ?></td>
                <td class="left"><?php echo $entry_date_start; ?></td>
                <td class="left"><?php echo $entry_time_start; ?></td>
                <td class="left"><?php echo $entry_date_end; ?></td>
                <td class="left"><?php echo $entry_time_end; ?></td>
                <td></td>
              </tr>
            </thead>
            ...
            <?php foreach ($product_specials as $product_special) { ?>
             ...
             <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                <td class="left">
	              <?php if($product_special['promotion']==1) {?>
	              	<input type="checkbox" name="product_special[<?php echo $special_row; ?>][promotion]" value="1" checked="checked" /><?php echo $entry_promotion_status;?>
	              <?php }else {?>	
	              <input type="checkbox" name="product_special[<?php echo $special_row; ?>][promotion]" value="1"  /><?php echo $entry_promotion_status;?>
	               <?php }?>	
             	</td>
                ...
                <td class="left"><input type="text" name="product_special[<?php echo $special_row; ?>][time_start]" value="<?php echo $product_special['time_start']; ?>" class="time" /></td>
                ...
                <td class="left"><input type="text" name="product_special[<?php echo $special_row; ?>][time_end]" value="<?php echo $product_special['time_end']; ?>" class="time" /></td>
...
<script type="text/javascript"><!--
			...
			$(document).ready(function(){
				$('input[name=\'combine\']').autocomplete({
					delay: 0,
...
var special_row = <?php echo $special_row; ?>;
			...
			function addSpecial() {
				...
				html += '  <tr>'; 
				html += '    <td class="left"><input type="checkbox" name="product_special[' + special_row + '][promotion]" value="1"  /><?php echo $entry_promotion_status;?></td>';
				...
				html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][time_start]" value="" class="time" /></td>';
				html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][date_end]" value="" class="date" /></td>';
				html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][time_end]" value="" class="time" /></td>';
				...
				$('#special-row' + special_row + ' .time').timepicker({timeFormat: 'h:m'});
