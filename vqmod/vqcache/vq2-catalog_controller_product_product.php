...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$promotion = $this->model_catalog_product->getProductSpecialPromotion($this->request->get['product_id']);
			
			if($promotion){
				$this->data['promotion_status']=$promotion['promotion'];
				$this->data['promotion_start']= date("Y-m-d H:i:s");
				$this->data['promotion_end']=$promotion['date_end'].' '.$promotion['time_end'];
			}
			...
			$this->data['text_combine_product'] = $this->language->get('text_combine_product');
			$this->data['text_combine_product_total'] = $this->language->get('text_combine_product_total');
			$this->data['button_combine_product_buy'] = $this->language->get('button_combine_product_buy');
			...
			$groups=$this->model_catalog_product->getProductGroups($this->request->get['product_id']);
